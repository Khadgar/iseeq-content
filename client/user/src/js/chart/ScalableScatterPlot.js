...
class ScalableScatterPlot {
    ...
    createChart(data) {
        ...
        // chart Container
        this.chartArea = main.append("g").attr("class", "chartContainer");
        ...
        // fisheye effect
        function redraw() {
            svg.selectAll(".from").attr("cx", (d, i) => {
                return self.fisheye(i);
            });
            svg.selectAll(".to").attr("cx", (d, i) => {
                return self.fisheye(i);
            });
            links
                .attr("x1", (e, t) => {
