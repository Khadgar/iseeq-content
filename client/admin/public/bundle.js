...
var _ApplicationWrapper = __webpack_require__(26);

var _ApplicationWrapper2 = _interopRequireDefault(_ApplicationWrapper);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_ApplicationWrapper2.default, null), document.getElementById("root"));
...
var ApplicationWrapper = function (_Component) {
    _inherits(ApplicationWrapper, _Component);

    function ApplicationWrapper() {
        _classCallCheck(this, ApplicationWrapper);

        var _this = _possibleConstructorReturn(this, (ApplicationWrapper.__proto__ || Object.getPrototypeOf(ApplicationWrapper)).call(this));
    ...
    _createClass(ApplicationWrapper, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            var _this2 = this;

            this._isMounted = true;
            fetch("http://iseeq-restapi.herokuapp.com/api/iseeq-store/list/all").then(function (response) {
        ...
        value: function render() {
            ...
            console.log(Content);
            return _react2.default.createElement("div", { className: "applicationWrapper container-fluid" });
        }
    }]);
...
exports.default = ApplicationWrapper;
